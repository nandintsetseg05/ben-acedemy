...
- Usage: Reference from command with `@C:/Users/User/ben academy/ben-acedemy/.cursor/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/Users/User/ben academy/ben-acedemy/.cursor/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/Users/User/ben academy/ben-acedemy/.cursor/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
